(() => {
  ...
  function startVehicleForm() {
    ...
    form.reset(); $('v-id').value = ''; $('v-driver-mode').value = 'without_driver'; $('v-driver-fee').value = 30000; $('v-extra-driver-fee').value = 30000; $('v-photo-url').value = ''; $('v-photo-file').value = ''; photoControls(); form.classList.remove('hidden');
  }
